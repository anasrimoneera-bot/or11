        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 text-gray-600">
            <tr>
              ...
              {isOwner && <th className="px-3 py-2 text-right text-red-600">真实(USD)</th>}
          ...
          <tbody>
            {rows.map(o => (
              <tr key={o.id} className="border-t hover:bg-gray-50">
                ...
                {isOwner && <td className="px-3 py-2 text-right text-red-600">${(o.real_amount_usd || 0).toFixed(2)}</td>}
                {isOwner && <td className="px-3 py-2 text-right text-red-600">{(o.markup_pct ?? 0)}%</td>}
